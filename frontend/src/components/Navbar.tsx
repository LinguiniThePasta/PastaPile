...
function Navbar() {
    return (
        <nav className={"p-5 flex justify-between items-center bg-white"}>
            <span className={"p-3 font-bold text-xl"}>PastaPile</span>
            <Searchbar></Searchbar>
            <span className={"flex justify-evenly items-center mr-20"}>
                <button className={"px-6 font-inter text-lg"}>About Me</button>
                <button className={"px-6 font-inter text-lg"}>Articles</button>
