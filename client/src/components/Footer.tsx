...
function Footer() {
    return (
        <>
            <div className={"flex justify-between my-5 pt-5 mx-20 border-t-2 border-gray-200"}>
                <Link to={"/"} className={"p-3 px-12 font-bold transition transform hover:scale-110 delay-75"}>PastaPile</Link>
