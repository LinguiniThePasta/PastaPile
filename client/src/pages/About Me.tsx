...
function AboutMe() {
    return (
        <>
            <Navbar />
            <div className={"flex flex-col items-center md:flex-row justify-between bg-gray-100 py-10"}>
                ...
                <div className={"md:mr-64 transition-all delay-75 duration-300 hover:scale-90"}>
            ...
            <div className={"flex flex-col items-end justify-end pr-64 py-24 "}>
                <div className={"text-5xl font-bold pb-1/10"}>Interests</div>
